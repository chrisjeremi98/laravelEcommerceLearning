                        ...
                        <div class="col-md-8">
                            ...
                            @else
                                <form action="{{ url('/cart') }}" method="POST" class="side-by-side">
                                    ...
                                    <input type="submit" class="btn btn-success btn-lg" value="Keranjang">
                                </form>
                                <form action="{{url('/wishlist')}}" method="POST" class="side-by-side">
                                    ...
                                    <input type="hidden" name="name" value="{{$product->name}}">
                                    <input type="hidden" name="price" value="{{$product->price}}">
                                    <input type="submit" class="btn btn-success btn-lg" value="Daftar Keinginan">
                                </form>
            ...
            <div class="col-md-3" style="margin-top: 50px">
                <div class="thumbnail">
                    <div class="caption text-center">
                        <a href="{{url('shop',[$product->slug])}}"><img src="{{asset('img/'.$product->image)}}"
